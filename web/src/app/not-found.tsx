  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[60vh] px-6 gap-6 text-center">
      ...
      <div>
        ...
        <p className="mt-2 text-text-muted text-sm">This page doesn&apos;t exist in the DC Decade.</p>
      </div>
      <Link href="/" className="px-4 py-2 bg-primary text-text-inverse rounded-lg text-sm font-medium hover:bg-primary-dark transition-colors">
        Go home
      </Link>
    </div>
  );
