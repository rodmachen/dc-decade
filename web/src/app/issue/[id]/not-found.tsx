...
export default function IssueNotFound() {
  return (
    <div className="flex flex-col items-center justify-center min-h-[60vh] px-6 gap-6 text-center">
      ...
      <div>
        <h1 className="text-xl font-bold text-text-primary">Issue not found</h1>
        <p className="mt-2 text-text-muted text-sm">This issue doesn&apos;t exist in the DC Decade.</p>
      </div>
