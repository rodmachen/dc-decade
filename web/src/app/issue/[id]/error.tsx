...
export default function IssueError({ reset }: { error: Error; reset: () => void }) {
  return (
    <div className="flex flex-col items-center justify-center min-h-[60vh] px-6 gap-4 text-center">
      <h1 className="text-xl font-bold text-text-primary">Could not load issue</h1>
      <p className="text-text-muted text-sm">There was a problem loading this issue.</p>
